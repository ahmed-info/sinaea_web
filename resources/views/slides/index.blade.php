                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">السلايدات</li>
                        </ol>
                    </nav>
                </div>
                    ...
                    <div class="d-lg-flex align-items-center mb-4 gap-3">
                        ...
                        <div class="justify-content-start">
                            <a href="{{ route('slides.create') }}"
                                class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>اضافة سلايد
                            </a>
                            </div>
                                ...
                                @if ($slides->count() > 0)
                                    @foreach ($slides as $index => $slide)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="">
                                                    <i class='bx bxs-circle me-1'></i>{{ $slide->title }}
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div class="">
                                                    <i class='bx bxs-circle me-1'></i>{{ $slide->brand->name }}
                                                </div>
                                            </td>
                                            <td>
                                                <div>
                                                    @if ($slide->image == null)
                                                        <img src="{{ asset('images/no-image.png') }}"
                                                            alt="{{ $slide->title }}" class="img-fluid" style="width: 50px">
                                                    @else
                                            ...
                                            <td>
                                                <div class="d-flex order-actions">
                                                    <a href="{{ route('slides.edit', $slide) }}" class=""><i
