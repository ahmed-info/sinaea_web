                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">القسم الفرعي</li>
                        </ol>
                    </nav>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-lg-flex align-items-center mb-4 gap-3">
                        <div class=""><a href="{{ route('categories.create') }}"
                            class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>اضافة قسم
                            فرعي</a></div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="badge rounded-pill text-success bg-light-success p-2 px-3">
                                                    <i class='bx bxs-circle me-1'></i>{{ $category->name }}
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div class="d-flex order-actions">
                                                    <a href="{{ route('categories.edit', $category) }}" class=""><i
