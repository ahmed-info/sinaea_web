...
<head>
    ...
    <title>Electro - HTML متجر Template</title>

    <!-- Google font -->
    <link href="https://fonts.googleapis.com/css?family=Montserrat:400,500,700" rel="stylesheet">

    <!-- Bootstrap -->
    <link type="text/css" rel="stylesheet" href="{{ asset('userAssets/css/bootstrap.min.css ') }}" />

    <!-- Slick -->
    <link type="text/css" rel="stylesheet" href="{{ asset('userAssets/css/slick.css') }}" />
    <link type="text/css" rel="stylesheet" href="{{ asset('userAssets/css/slick-theme.css') }}" />

    <!-- nouislider -->
    <link type="text/css" rel="stylesheet" href="{{ asset('userAssets/css/nouislider.min.css') }}" />

    <!-- Font Awesome Icon -->
    <link rel="stylesheet" href="{{ asset('userAssets/css/font-awesome.min.css') }}">

    <!-- Custom stlylesheet -->
    <link type="text/css" rel="stylesheet" href="{{ asset('userAssets/css/style.css') }}" />
        ...
        <div id="top-header">
            <div class="container">
                <ul class="header-links pull-right">
                    ...
                    <li><a href="#"><i class="fa fa-map-marker"></i>بغداد- شارع الصناعة - عمارة النعمان</a></li>
                </ul>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="header-logo">
                            <a href="#" class="logo">
                                <img src="{{ asset('userAssets/img/logo.png') }}" alt="">
                            </a>
                        </div>
                    </div>
                    <!-- /LOGO -->
                                    ...
                                    <div class="cart-list">
                                        <div class="product-widget">
                                            <div class="product-img">
                                                <img src="{{ asset('userAssets/img/product01.png') }}" alt="">
                                            </div>
                                        ...
                                        <div class="product-widget">
                                            <div class="product-img">
                                                <img src="{{ asset('userAssets/img/product02.png') }}" alt="">
                                            </div>
                                            <div class="product-body">
                                                <h3 class="product-name"><a href="#">product name goes here</a>
                                                </h3>
