       ...
       <!-- Jquery Min JS -->
            ...
            <script src="{{ asset('assetcart/lib/easing/easing.min.js')}}"></script>
            <script src="{{ asset('assetcart/lib/owlcarousel/owl.carousel.min.js')}}"></script>

            <!-- Contact Javascript File -->
            <script src="{{ asset('assetcart/mail/jqBootstrapValidation.min.js')}}"></script>
            <script src="{{ asset('assetcart/mail/contact.js')}}"></script>

            <!-- Template Javascript -->
            <script src="{{ asset('assetcart/js/main.js')}}"></script>
