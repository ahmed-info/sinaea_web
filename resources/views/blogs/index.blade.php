                    ...
                    <div class="d-lg-flex align-items-center mb-4 gap-3">
                        ...
                        <div class="justify-content-start">
                            <a href="{{ route('blogs.create') }}"
                                class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>اضافة مدونة
                            </a>
                            </div>
                                ...
                                @if ($blogs->count() > 0)
                                    @foreach ($blogs as $index => $blog)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="">
                                                    <i class='bx bxs-circle me-1'></i>{{ $blog->title }}
                                                </div>
                                            </td>
                                                ...
                                                <div>
                                                    @if ($blog->image == null)
                                                        <img src="{{ asset('images/no-image.png') }}"
                                                            alt="{{ $blog->title }}" class="img-fluid" style="width: 50px">
                                                    @else
                                            ...
                                            <td>
                                                <div class="d-flex order-actions">
                                                    <a href="{{ route('blogs.edit', $blog) }}" class=""><i
                                                            class='bx bxs-edit'></i></a>
                                                    <form action="{{ route('slides.destroy', $blog) }}" method="POST"
